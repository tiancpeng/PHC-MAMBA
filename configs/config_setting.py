...
class setting_config:
    ...
    datasets = 'STARE'
    if datasets == 'DRIVE':
        data_path = '/public/home/xukai_tcp_2607/final-UltraLight-VM-UNet/dataprepare/DRIVE/'
    elif datasets == 'CHASEDB':
        data_path = '/public/home/xukai_tcp_2607/final-UltraLight-VM-UNet/dataprepare/CHASEDB/'
    elif datasets == 'STARE':
        data_path = '/public/home/xukai_tcp_2607/final-UltraLight-VM-UNet/dataprepare/STARE/'
    else:
    ...
    if opt == 'Adadelta':
        ...
        lr = 2e-2 # default: 2e-3 – learning rate
        betas = (0.9, 0.999) # default: (0.9, 0.999) – coefficients used for computing running averages of gradient and its square
        eps = 1e-8 # default: 1e-8 – term added to the denominator to improve numerical stability
